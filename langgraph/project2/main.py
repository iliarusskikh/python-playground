...
# user question -> 
# [Google Search, Bing Search, Reddit Search] -> 
# Analyze Reddit posts -> 
# Retrieve relevant Reddit Posts -> 
# [Analyze Google Results (Focused Prompt), Analyse Bing Results (Focused Prompt), Analyse Reddit Results (Focused Prompt)] -> 
# Synthesize Analyses (Combine insights) ->
#  Final answer
...
graph_builder.add_edge("google_search", "analyze_reddit_posts") # wait for all searches to be completed
